...
// toggles collapse/expand of side menu when an item is clicked
$('a[href="' + this.location.pathname + '"]').parents('li,ul').addClass('active').addClass('in');
$('a[href="' + this.location.pathname + '"]').addClass('active').addClass('in');
