...
namespace JobEngine.Web
{
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db)
        {
            ...
            //Create Configuration Editors if it does not exist
            var configRole = roleManager.FindByName("Configuration Editors");
            if (configRole == null)
            {
                role = new ApplicationRole("Configuration Editors");
                var roleresult = roleManager.Create(configRole);
            }
